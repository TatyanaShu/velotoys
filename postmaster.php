<?php
$EMAIL = 'tanya-repz@mail.ru'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'tanya-repz@mail.ru';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'tanya-repz@mail.ru';   //  e-mail для ответа 
